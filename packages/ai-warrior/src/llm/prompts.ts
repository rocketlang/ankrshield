...
export function buildNarrationPrompt(agentName: string, events: ThreatEvent[]): string {
...
export function buildTechnicalAnalysisPrompt(chains: AttackChain[], honeypotCount: number): string {
