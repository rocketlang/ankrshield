...
const electronAPI: ElectronAPI = {
  ...
  dns: {
    ...
    getRecentQueries: (limit: number = 50) => ipcRenderer.invoke('dns:getRecentQueries', limit),
    toggleProtection: (enabled: boolean) => ipcRenderer.invoke('dns:toggleProtection', enabled),
  ...
  network: {
    ...
    toggleProtection: (enabled: boolean) => ipcRenderer.invoke('network:toggleProtection', enabled),
