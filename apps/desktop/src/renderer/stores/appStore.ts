...
export const useProtectionStatus = () =>
  useAppStore((state) => state.protectionEnabled);

export const usePrivacyScore = () =>
  useAppStore((state) => state.privacyScore);

export const useNetworkStats = () =>
  useAppStore((state) => state.networkStats);

export const useDnsStats = () =>
  useAppStore((state) => state.dnsStats);

export const useTopTrackers = () =>
  useAppStore((state) => state.topTrackers);
