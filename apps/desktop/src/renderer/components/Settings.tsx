        ...
        <section className="settings-section">
          ...
          <div className="setting-item">
            ...
            <label className="toggle-switch">
              <input type="checkbox" checked={dnsProtection} onChange={handleDnsToggle} />
          ...
          <div className="setting-item">
            ...
            <label className="toggle-switch">
              <input type="checkbox" checked={networkProtection} onChange={handleNetworkToggle} />
              <span className="toggle-slider"></span>
            </label>
          </div>
        </section>
        ...
        <section className="settings-section">
          ...
          <div className="setting-item">
            <div className="setting-info">
              ...
              <div className="setting-description">Show notifications when threats are blocked</div>
            </div>
            <label className="toggle-switch">
              <input
                type="checkbox"
