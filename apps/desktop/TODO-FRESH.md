...
2. Zustand stores
3. React Router
   → _Quick visual improvement, better state management_

**Sprint 2: Persistence (60 min)** 4. electron-store integration
→ _Settings work properly_

**Sprint 3: Backend (150 min)** 5. Network service completion 6. Privacy service completion
→ _Real data flowing_

**Sprint 4: Polish (90 min)** 7. Component library 8. Testing
