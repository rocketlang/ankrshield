// HanumanG — Evidence Notary client (Ed25519 notarization)
// @rule:HNG-P2-001 — attestation issuance is the reliable floor (FP-010); notarization
// is best-effort and fails LOUD (_meta.notarized:false + notary_error), never blocks.
// @rule:HNG-S-001 — notary base resolved from the ports.json authority (R-008); no port literal.
