...
function FeatureCard({
  ...
  return (
    <div
      className={`group rounded-2xl border border-white/5 bg-white/[0.02] p-6 transition-all hover:bg-white/[0.04] ${border}`}
    >
  ...
  return (
    <div className="min-h-screen bg-[#080c14] text-white font-sans antialiased">
      ...
      <section className="relative overflow-hidden">
        ...
        />
        {/* Glow blobs */}
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[800px] h-[400px] bg-cyan-600/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-20 right-0 w-80 h-80 bg-blue-700/5 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 pt-28 pb-24 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-16">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 text-white font-semibold px-8 py-4 rounded-xl transition-all text-base"
            >
          ...
          {/* Live stats strip */}
          <div className="inline-flex items-center gap-8 bg-white/[0.03] border border-white/5 rounded-2xl px-8 py-4">
      ...
      <div className="border-y border-white/5 bg-white/[0.015] overflow-hidden py-3">
        <div className="flex gap-12 animate-[marquee_30s_linear_infinite] whitespace-nowrap text-xs text-gray-600 font-mono">
          {Array(3)
            .fill([
      ...
      {/* ── How it works ── */}
      <section id="how-it-works" className="border-t border-white/5 bg-white/[0.01]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 relative">
            ...
            {[
              ...
              <div
                key={s.n}
                className="flex flex-col items-center text-center bg-white/[0.02] border border-white/5 rounded-2xl p-8 hover:border-cyan-500/20 transition-colors"
              >
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/20 flex items-center justify-center text-cyan-400 text-2xl font-black mb-5">
                  {s.n}
                </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 py-20">
        <div className="rounded-3xl border border-red-500/10 bg-red-950/5 overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row items-start gap-12">
              ...
              <div className="flex-1">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 bg-red-600/10 hover:bg-red-600/20 border border-red-500/30 text-red-400 font-bold px-6 py-3 rounded-xl transition-all text-sm"
                >
                  <span className="w-2 h-2 rounded-full bg-red-500 animate-pulse" />
              ...
              <div className="w-full lg:w-[400px] shrink-0">
                <div className="bg-[#0a0f1a] border border-white/10 rounded-2xl overflow-hidden shadow-2xl">
                  ...
                  <div className="p-5 font-mono text-xs space-y-2">
                    <div className="text-gray-600">$ xshield warrior start</div>
                    ...
                    <div className="text-gray-600 mt-3">Waiting for threats...</div>
                    <div className="text-yellow-400">⚠️ [16:17:47] 185.220.101.45 → /.env</div>
                    <div className="text-orange-400">📡 AbuseIPDB report submitted</div>
                    <div className="text-red-400">🚫 iptables DROP rule added</div>
                    <div className="text-purple-400">🔍 Pre-block: 91.92.240.28 · score 92%</div>
                    <div className="text-purple-400">🌐 Known threat · Access denied · 403</div>
                    <div className="text-gray-600 animate-pulse mt-2">█</div>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              <div
                key={o.name}
                className="border border-white/5 rounded-xl p-4 text-center hover:border-white/10 transition-colors"
              >
                <div className="text-2xl mb-2">{o.icon}</div>
                <div className="text-white text-sm font-semibold">{o.name}</div>
                <div className="text-gray-600 text-xs mt-0.5">{o.label}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ── Download / CTA ── */}
      <section id="download" className="border-t border-white/5 relative overflow-hidden py-24">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[300px] bg-cyan-600/5 rounded-full blur-3xl" />
        </div>
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-center gap-10">
            {/* QR card */}
            <div className="bg-white/[0.03] border border-white/10 rounded-2xl p-8 flex flex-col items-center gap-5 shadow-2xl">
              ...
              <p className="text-gray-600 text-xs text-center max-w-[200px]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-2.5">
              ...
              <span className="text-gray-700 text-sm ml-1">— AI-Native Cybersecurity</span>
            </div>
            <div className="flex items-center gap-6 text-sm text-gray-600">
              ...
              <a href="/evidence" className="hover:text-gray-300 transition-colors">
                Evidence
              </a>
            </div>
